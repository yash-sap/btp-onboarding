...
Next, during the **Joule Booster** (an automated integration process), ensure that you select the SAP Concur system . As mentioned above, you should be able to see the Joule formation in Ready status.
